...
if len(sys.argv) != 2:
    print('Usge: {} test_split_name'.format(sys.argv[0]))
    sys.exit(1)
...
# !!! test_data, name_size_file, num_test_image SHOULD match !!!
test_data = "lmdb/{}_lmdb".format(split_name)
name_size_file = "helper/{}_name_size.txt".format(split_name)
...
snapshot_dir = "snapshots/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/{}_score_{}".format(job_name, split_name)
# Directory which stores the detection results.
output_result_dir = "results/{}_score_{}".format(job_name, split_name)
...
AddExtraLayers(net, use_batchnorm, lr_mult=lr_mult/10.)
