...
train_data = "lmdb/test_lmdb"
# !!! test_data, name_size_file, num_test_image SHOULD match !!!
test_data = "lmdb/train_lmdb"
name_size_file = "helper/train_name_size.txt"
...
job_dir = "jobs/{}_score_tr".format(job_name)
# Directory which stores the detection results.
output_result_dir = "results/{}_score_tr".format(job_name)
